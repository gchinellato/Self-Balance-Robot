...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label = QtGui.QLabel(self.groupBox_PID)
        self.label.setGeometry(QtCore.QRect(0, 20, 101, 17))
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(self.groupBox_PID)
        ...
        self.groupBox_Motor.setGeometry(QtCore.QRect(320, 180, 121, 181))
        ...
        self.groupBox_server_settings = QtGui.QGroupBox(self.groupBox)
        ...
        self.groupBox_client_settings = QtGui.QGroupBox(self.groupBox)
        ...
        self.pushButton_restartUDP = QtGui.QPushButton(self.groupBox)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Mr. Robot Manager", None))
        self.groupBox_PID.setTitle(_translate("MainWindow", "PID Controllers", None))
        ...
        self.label.setText(_translate("MainWindow", "Angle Control", None))
        self.label_2.setText(_translate("MainWindow", "Speed Control", None))
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Connection settings", None))
        self.groupBox_server_settings.setTitle(_translate("MainWindow", "Server UDP", None))
        ...
        self.groupBox_client_settings.setTitle(_translate("MainWindow", "Client UDP", None))
